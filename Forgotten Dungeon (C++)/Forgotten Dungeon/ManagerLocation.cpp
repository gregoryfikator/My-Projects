...
ManagerLocation::ManagerLocation() : Manager()
{
...
void ManagerLocation::Init(string bmpFile, string obstacleFile, string characterFile) // a moze konstruktor??
{
...
int ManagerLocation::GetXPos() { return currentLocation->GetXPos(); }
int ManagerLocation::GetYPos() { return currentLocation->GetYPos(); }
Location* ManagerLocation::GetCurrentLocation() { return currentLocation; }
void ManagerLocation::DrawCurrentLocation() { currentLocation->DrawCurrentLocation(); }
void ManagerLocation::RespawnEnemy()
{
...
void ManagerLocation::DrawSpawnedEnemies()
{
...
bool ManagerLocation::GetFightStatus() { return fight; }
void ManagerLocation::SetFightStatus(bool newStatus) { fight = newStatus; }
int ManagerLocation::GetSpawnedEnemyIndex() { return spawnedEnemyIndex; }
Character* ManagerLocation::GetEnemy() { return spawnedEnemies->at(spawnedEnemyIndex); }
void ManagerLocation::KillEnemy() { this->GetEnemy()->Kill(); }

bool ManagerLocation::ColisionTest(int heroX1Pos, int heroY1Pos, int heroX2Pos, int heroY2Pos, int direction)
{
	int MapX = currentLocation->GetXPos();
	int MapY = currentLocation->GetYPos();
