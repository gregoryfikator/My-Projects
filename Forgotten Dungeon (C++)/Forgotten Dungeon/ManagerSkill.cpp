...
ManagerSkill::ManagerSkill() : Manager()
{
	skillList = nullptr;
...
void ManagerSkill::Init(string itemFile)
{
...
void ManagerSkill::Draw(Resources *resources, ALLEGRO_Font *allegro_font)
{
...
int ManagerSkill::GetDescriptionDrawPosition() { return position; }

void ManagerSkill::DrawDescription(int mouseX, int mouseY, Hero *hero, Skill *skill, ALLEGRO_Font *fonts, int y)
{
...
void ManagerSkill::DrawDockedSkills(int MouseX, int MouseY, Hero *hero, ALLEGRO_Font *fonts, bool openEquipment, bool openSkillTab)
{
...
void ManagerSkill::DrawSelectedSkill(int MouseX, int MouseY, Hero *hero)
{
...
void ManagerSkill::AquireSkill(Hero *hero)
{
...
void ManagerSkill::ProceedSelection(Hero *hero, int slot, bool LMBPressed, bool ToDock)
{
	if (LMBPressed == true)
	{
		if (selectedFromTab == false)
...
void ManagerSkill::CheckCursorOverlayDockAndClick(int mouseX, int mouseY, Hero *hero, bool LMBPressed, bool SkillTabOpen) // funkcja jest 'nieelegancko' wykonana ze wzgledu na ograniczenia czasowe
{
	int dockX = 230;
	int dockY = 424;
...
void ManagerSkill::CheckCursorOverlayTabAndClick(int mouseX, int mouseY, Hero *hero, bool LMBPressed) // funkcja jest 'nieelegancko' wykonana ze wzgledu na ograniczenia czasowe
{
	overlayDock = false;
...
bool ManagerSkill::CheckButtons(int mouseX, int mouseY, Hero *hero, bool LMBPressed)
{
	if (LMBPressed)
	{
...
void ManagerSkill::ResetSkillTab()
{
	selectedSkill = nullptr;
	overlayedSkillIndex = -1;
	selectedSkillIndex = -1;
